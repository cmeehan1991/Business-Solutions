...
import users.createnew.NewUserMain;
...
public class UserLoginController implements Initializable {
    ...
    public void userSignIn(ActionEvent event) throws Exception {
        UserLoginMain userSignIn = new UserLoginMain();
        String username = usernameTextField.getText();
        String password = passwordTextField.getText();
        String userID = userSignIn.SignIn(username, password);
    ...
    public void createNewUser(ActionEvent event) throws IOException{
        NewUserMain newUser = new NewUserMain();
