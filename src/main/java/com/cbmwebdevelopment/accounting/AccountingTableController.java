...
public class AccountingTableController {
    ...
    ObservableList<AccountingItems> data;
    ...
    public void fillAccountingTable(String paid, String fromDate, String toDate, String transactionType, String searchTerms, TableView tableView) throws SQLException{
        ...
        try{
            ...
            if(rs.next()){
                do{
                    data.addAll(new AccountingItems(false, rs.getString("COMPANY_NAME"), rs.getString("DATE_CREATED"), rs.getString("LAST_UPDATED"), rs.getString("TYPE"), rs.getString("ID"), rs.getString("STATUS"), rs.getString("MEMO"), rs.getString("AMOUNT")));
                }while(rs.next());
            }
