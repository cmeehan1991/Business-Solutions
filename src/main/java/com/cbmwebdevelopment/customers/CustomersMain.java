...
public class CustomersMain extends Application {
    ...
    public void loadClient() throws IOException {
        ...
        try {
            ...
            if (rs.next()) {
                ...
                FXMLLoader loader = new FXMLLoader(getClass().getClassLoader().getResource("fxml/CustomersFXML.fxml"));
    ...
    public void start(Stage primaryStage) throws IOException, SQLException {
        ...
        controller.companyID = Integer.parseInt(client.clientID(companyName));
